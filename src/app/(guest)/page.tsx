...
import { Consultation } from "@/lib/backend/api";
import ChatConsultation from "@/app/(guest)/components/consultation/ChatConsultation";
import { Message } from "@/types/common";
import { useRouter } from "next/navigation";
import { TokenTracker } from "@/lib/frontend/tokenTracker";
import UpgradeModal from "@/app/(guest)/components/modals/UpgradeModal";
    ...
    async (userIssue: string) => {
      ...
      try {
        ...
        if (contentType?.includes("text/event-stream")) {
          ...
          // Store initial messages and navigate to research page immediately
                  ...
                  if (line.startsWith("data: ")) {
                    ...
                    if (data.type === "metadata") {
                      ...
                      if (data.tokensUsed) {
                        ...
                        // Update local state
                        const updatedUsage =
                          TokenTracker.getUsageSummary(userId);
                        setTokenUsage({
  ...
  return (
    <>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ChatConsultation onSubmit={handleSubmitIssue} isLoading={isLoading} />
      </div>

...
export function AttorneyLayout({ children, unreadCount = 0 }: AttorneyLayoutProps) {
          ...
          <>
            ...
            {!showMobileSidebar && (
              <button
                ...
                className="fixed bottom-6 left-6 z-30 w-14 h-14 rounded-full shadow-lg flex items-center justify-center"
                style={{

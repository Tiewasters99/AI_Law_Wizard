...
import { FileText, Clock, LogOut, FileStack, Search, Menu, X } from 'lucide-react'
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4 min-w-0 flex-1">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg font-bold text-gray-900">Docket Genie</h1>
          ...
          {showMiniSearch && isAuthenticated && (
            <form onSubmit={handleMiniSearch} className="hidden lg:flex items-center flex-1 max-w-md mx-4">
              ...
              <>
                ...
                <div className="hidden lg:flex items-center gap-3 px-3 py-2 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-green-900">{username}</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-green-700 border-l border-green-300 pl-3">
                    <Clock className="w-3 h-3" />
                    <span className="font-mono">{timeRemaining || 'Active'}</span>
                  </div>
                  {sessionCost > 0 && (
                  ...
                  <div className="px-2 py-2 bg-green-50 border border-green-200 rounded-lg mx-2">
                    <div className="flex items-center justify-between text-xs">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-green-900">{username}</span>
                      </div>

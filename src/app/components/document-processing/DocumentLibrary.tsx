...
export function DocumentLibrary({ className }: DocumentLibraryProps) {
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <div className="flex items-center space-x-4 flex-1 min-w-0">
                              ...
                              <div className="flex-1 min-w-0">
                                <h3 className="font-medium text-gray-900 text-base mb-2" title={document.originalName}>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm text-gray-500">
                                  ...
                                  {document.status === 'PROCESSING' && (
                                    <span className="flex items-center space-x-1 text-blue-600">
                                      ...
                                      <span>{document.processedChunks}/{document.totalChunks} chunks</span>
                                    </span>
                                  )}
                                </div>
                              </div>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3 flex-shrink-0">
                              <Badge 
                                variant="secondary" 
                                className={`text-sm px-3 py-1 w-fit ${getStatusColor(document.status)}`}
                              >

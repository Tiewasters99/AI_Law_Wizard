    ...
    <>
      <motion.header
        ...
        style={{
          ...
          borderBottom: isScrolled ? `1px solid ${colors.secondary[200]}` : '1px solid transparent',
        ...
        {isMobileMenuOpen && (
          <>
            ...
            >
              ...
              {/* Mobile CTAs */}
              <div className="p-6 space-y-3 border-t" style={{ borderColor: colors.secondary[200] }}>
                <Button
                  variant="outline"

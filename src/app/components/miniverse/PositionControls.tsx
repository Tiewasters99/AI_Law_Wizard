    ...
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="space-y-2">
        <div className="flex items-center space-x-2">
          <label className="text-xs text-gray-400 w-4" title="X position (left/right)">X:</label>
          <input
            type="range"
            min="-25"
            max="25"
          ...
          />
          <span className="text-xs text-gray-400 w-12 text-right" title="Current X value">{position.x.toFixed(1)}</span>
        </div>
        <div className="flex items-center space-x-2">
          <label className="text-xs text-gray-400 w-4" title="Y position (up/down)">Y:</label>
          <input
            type="range"
            min="0"
            max="10"
          ...
          />
          <span className="text-xs text-gray-400 w-12 text-right" title="Current Y value">{position.y.toFixed(1)}</span>
        </div>
        <div className="flex items-center space-x-2">
          <label className="text-xs text-gray-400 w-4" title="Z position (forward/back)">Z:</label>
          <input
            type="range"
            min="-25"
            max="25"
          ...
          />
          <span className="text-xs text-gray-400 w-12 text-right" title="Current Z value">{position.z.toFixed(1)}</span>
        </div>
      </div>
    </div>
  )

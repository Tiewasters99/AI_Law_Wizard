...
export const MusicPlayer: React.FC<MusicPlayerProps> = ({
  ...
  const isLocalAudio = currentTrack.url.startsWith('/music/') && currentTrack.url.endsWith('.mp3');
        ...
        <div className="relative">
              ...
              {playerError && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/90 z-10 p-4">
                  ...
                  <div className="space-y-2">
                    {!isLocalAudio && currentTrack.watchUrl && currentTrack.watchUrl.includes('youtube.com') && (
                      <a
          ...
          <div className="p-3 space-y-3">
            ...
            <div className="text-xs text-gray-400 text-center bg-slate-800/30 rounded-lg p-2">
              {isLocalAudio ? 'Use audio controls to play/pause' : 'Use player controls to play/pause'}
            </div>
              ...
              <div className="space-y-1">
                {tracks.length > 0 ? (
                  ...
                  <div className="text-center py-4">
                    ...
                    <p className="text-xs text-gray-400 mb-2">No music added yet</p>
                    <p className="text-xs text-gray-500">Use library button in header to add music</p>
                  </div>
                )}
              </div>
            </div>

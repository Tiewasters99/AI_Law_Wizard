  ...
  devtools(
    persist(
      (set) => ({
        ...
        toggleFileEditor: () => set((state) => ({ showFileEditor: !state.showFileEditor })),
        
        toggleFileManager: () => set((state) => ({ showFileManager: !state.showFileManager })),
        
        toggleQueryHistory: () => set((state) => ({ showQueryHistory: !state.showQueryHistory })),
        
        toggleResultModal: () => set((state) => ({ showResultModal: !state.showResultModal })),
        
        toggleChatMode: () => set((state) => ({ showChatMode: !state.showChatMode })),
        
        setEditedFile: (content) => set({ editedFile: content }),
        
        setGeneratedFile: (content) => set({ generatedFile: content }),
        
        toggleExpandedResult: (id) => set((state) => {

...
interface ClientFeaturesPanelProps {
  features: Feature[];
  searchTerm: string;
...
const categoryGroups = {
  "Find Legal Help": ["client_directory"],
  "AI Tools": ["client_wizard", "client_grand_wizard", "client_legal_chat"],
  "My Space": ["client_inbox", "client_integrations"],
  Resources: ["client_blog", "client_miniverse"],
  Account: ["client_profile", "client_tokens"],
  Dashboard: ["client_dashboard"],
};

export function ClientFeaturesPanel({
  features,
  searchTerm,
  onFeatureToggle,
}: ClientFeaturesPanelProps) {
                            ...
                            confirmationMessage={
                              ...
                              feature.name.includes("chat")
                                ? `This will ${
                                  ...
                                  } a core AI feature. Are you sure?`
                                : undefined
                            }
                          />
                        </div>

...
export const CameraRig: React.FC = () => {
  ...
  useFrame(() => {
    ...
    camera.position.x = Math.max(
      CAMERA_SETTINGS.boundary.minX,
      Math.min(CAMERA_SETTINGS.boundary.maxX, camera.position.x)
    );
    camera.position.z = Math.max(
      CAMERA_SETTINGS.boundary.minZ,
      Math.min(CAMERA_SETTINGS.boundary.maxZ, camera.position.z)
    );

      ...
      <div className="relative backdrop-blur-xl bg-gradient-to-br from-slate-800/60 via-slate-900/50 to-slate-950/60 border border-slate-400/40 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="relative p-5">
          ...
          <button
            ...
            onClick={onClose}
          >
            <span className="text-white text-lg font-light group-hover:rotate-90 transition-transform duration-300">
              ×
            </span>
          </button>
          ...
          <div className="space-y-3 text-xs">
            <div className="flex items-center justify-between text-white py-1">
              <span className="flex items-center space-x-1.5">
                <kbd className="px-2 py-1 bg-slate-700/60 rounded border border-slate-400/40 text-[10px] text-white">
                  WASD
                </kbd>
            ...
            <div className="flex items-center justify-between text-white py-1">
              <kbd className="px-2.5 py-1 bg-slate-700/60 rounded border border-slate-400/40 text-[10px] text-white">
                Click
              </kbd>

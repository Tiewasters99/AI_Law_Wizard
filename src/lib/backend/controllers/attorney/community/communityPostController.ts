// Controller for attorney community post operations
...
import {
  ...
  updatePost,
  listPosts,
} from "../../../services/attorney/community/communityPostService";
...
export async function handleUpdatePost(
  ...
  try {
    ...
    const post = await updatePost(postId, updateData, attorney.id);
...
export async function handleListPosts(
  ...
  try {
    ...
    const posts = await listPosts(communityId, attorney.id, { skip, take });

// Service for client OneDrive authentication
...
/**
 * Generate OneDrive authentication URL for client
 */
export function generateClientOneDriveAuthUrl(): OneDriveAuthUrlResponse {
  ...
  const params = new URLSearchParams({
    ...
    scope: scope,
    response_mode: "query",
    state: "client", // Add state to identify client role
  });

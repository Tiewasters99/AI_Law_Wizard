// Service for client OneDrive file operations
...
/**
 * List OneDrive files for client
 */
export async function listClientOneDriveFiles(
  cookies: any,
...
/**
 * Download OneDrive file for client
 */
export async function downloadClientOneDriveFile(
  cookies: any,
  fileId: string
